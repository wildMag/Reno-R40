 ...
 * Created:     		28/3/2008
 * Modified:    		16/02/2010 by Magali Linckels
 * Modification notes:  Modified to include accessibility functions
 * Language:    		Javascript
	     ...
	     *           node:nPaging - the DIV which contains this pagination control
			...
			"fnInit": function ( oSettings, nPaging, fnCallbackDraw )
			{
				...
				else
				{
					...
					nNextInner = document.createElement('a');
					nNextInner.className = oSettings.oClasses.sPageJUINext;
					nNext.appendChild( nNextInner );
					
					nPreviousInner = document.createElement('a');
	     ...
	     *           node:nPaging - the DIV which contains this pagination control
			...
			"fnUpdate": function ( oSettings, fnCallbackDraw )
			{
				...
				for ( i=0, iLen=an.length ; i<iLen ; i++ )
				{
					...
					$('a', nPaginateList).click( fnClick ).bind( 'mousedown', fnFalse )
